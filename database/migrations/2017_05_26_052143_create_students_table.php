...
class CreateStudentsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Students", 'students', 'name', 'fa-user', [
            ["name",        "Name",         "Name",     false, "John Doe",  5,  250,    true],
            ["class",      "Class",       "String",   false, "Programming", 0, 250,   true],
            ["trade",   "Trade",    "Dropdown", false, "Engineering",    0,  0,      false, ["Engineering","Management"]],
